package ru.flocator.app.map.domain.comparing


import ru.flocator.app.map.domain.dto.MarkGroupViewDto
import ru.flocator.app.map.domain.dto.MarkViewDto
import ru.flocator.app.map.domain.dto.UserViewDto
