package com.example.flocator.main.ui.map.ui
...
import com.example.flocator.main.ui.map.domain.difference.Difference
import com.example.flocator.main.ui.map.domain.difference.MapItemsDifferenceCalculator
...
import com.example.flocator.main.ui.map.domain.map.*
...
import com.example.flocator.main.ui.map.utils.DisposableMapItemsUtils
import com.example.flocator.main.ui.map.view_models.FLocatorMapFragmentViewModel
...
class FLocatorMapFragment :
    ...
    private fun makeUsersDifference(users: List<User>): Difference<UserViewDto> {
        ...
        return MapItemsDifferenceCalculator.calculateDifference(
            currentUsers,
            newUsers,
            com.example.flocator.main.ui.map.domain.comparing.MapItemsCompareCallbacks.UserCompareCallback
        )
    }
    ...
    private fun makeSingleMarksDifference(newMarks: List<MarkGroup>): Difference<MarkViewDto>? {
        ...
        return MapItemsDifferenceCalculator.calculateDifference(
            ...
            singleMarks,
            com.example.flocator.main.ui.map.domain.comparing.MapItemsCompareCallbacks.MarkCompareCallback
        )
    }
    ...
    private fun makeGroupMarksDifference(newMarks: List<MarkGroup>): Difference<MarkGroupViewDto> {
        ...
        return MapItemsDifferenceCalculator.calculateDifference(
            currentMarkGroups,
            groupMarks,
            com.example.flocator.main.ui.map.domain.comparing.MapItemsCompareCallbacks.MarkGroupCompareCallback
        )
    }
