...
object MapItemsCompareCallbacks {
    object MarkCompareCallback : CompareCallback<MarkViewDto> {
    ...
    object MarkGroupCompareCallback : CompareCallback<MarkGroupViewDto> {
    ...
    object UserCompareCallback : CompareCallback<UserViewDto> {
