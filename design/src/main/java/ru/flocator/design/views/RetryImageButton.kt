package ru.flocator.design.views
    ...
    init {
        ...
        imageButton.setImageDrawable(
            ResourcesCompat.getDrawable(
                context.resources,
                R.drawable.reload_image,
                null
            )
        )
        imageButton.backgroundTintList =
            ResourcesCompat.getColorStateList(context.resources, R.color.transparent, null)
        imageButton.imageTintList =
            ResourcesCompat.getColorStateList(context.resources, R.color.tint, null)
