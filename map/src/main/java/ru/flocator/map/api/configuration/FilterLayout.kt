...
import ru.flocator.core.utils.AnimationUtils
...
class FilterLayout @JvmOverloads constructor(
    ...
    companion object {
        ...
        @ColorRes
        private val backgroundColorCollapsed: Int = ru.flocator.design.R.color.white

        @ColorRes
        private val backgroundColorExpanded: Int = ru.flocator.design.R.color.tint

        @ColorRes
        private val textColorCollapsed: Int = ru.flocator.design.R.color.tint

        @ColorRes
        private val textColorExpanded: Int = ru.flocator.design.R.color.white

        // Filter Buttons
        @ColorRes
        private val nonActiveBackgroundColor: Int = ru.flocator.design.R.color.white

        @ColorRes
        private val activeBackgroundColor: Int = ru.flocator.design.R.color.secondary

        @ColorRes
        private val filterButtonTextColor: Int = ru.flocator.design.R.color.tint
    }
    ...
    private fun initToggleButton() {
        ...
        filterToggleButton.textSize =
            BUTTON_TEXT_SIZE
        filterToggleButton.iconSize = buttonIconSize
        filterToggleButton.cornerRadius = ViewUtils.dpToPx(
            BUTTON_CORNER_RADIUS, context
        )
        ...
        filterToggleButton.letterSpacing =
    ...
    private fun initFilterButton(index: Int) {
        ...
        item.button.apply {
            ...
            (this.layoutParams as MarginLayoutParams).topMargin =
                MARGIN_TOP
    ...
    private fun collapseButton(index: Int) {
        ...
        animator = ValueAnimator.ofFloat(0f, 1f).apply {
            duration =
                BUTTON_TRANSLATE_ANIMATION_DURATION
            doOnEnd {
